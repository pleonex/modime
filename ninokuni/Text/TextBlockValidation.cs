...
namespace Ninokuni
{
	...
	{
		static readonly Dictionary<int, object[]> SupportedFiles = new Dictionary<int, object[]> {
			...
			{ 0x2A99, new object[] { false, false, false, true,  0x0C4, 0x00, 0x00, "EquipItemInfo"       } },
			{ 0x2A9A, new object[] { false, false, false, true,  0x051, 0x00, 0x00, "EquipItemLinkInfo"   } },
			{ 0x2A9B, new object[] { true,  true,  true,  true,  0x020, 0x30, 0x00, "EquipItemParam"      } },
			{ 0x2A9C, new object[] { false, false, false, true,  0x072, 0x00, 0x00, "ItemGetInfo"         } },
			{ 0x2A9D, new object[] { false, false, false, true,  0x0C4, 0x00, 0x00, "ItemInfo"            } },
			{ 0x2A9E, new object[] { false, false, false, true,  0x051, 0x00, 0x00, "ItemLinkInfo"        } },
			{ 0x2A9F, new object[] { true,  true,  true,  true,  0x020, 0x4C, 0x00, "ItemParam"           } },
			{ 0x2AA0, new object[] { false, false, false, true,  0x072, 0x00, 0x00, "SpItemGetInfo"       } },
			{ 0x2AA1, new object[] { false, false, false, true,  0x0C4, 0x00, 0x00, "SpItemInfo"          } },
			{ 0x2AA2, new object[] { true,  true,  true,  true,  0x020, 0x10, 0x00, "SpItemParam"         } },
			{ 0x2AA3, new object[] { true,  false, false, true,  0x0C4, 0x00, 0x00, "MagicInfo"           } },
